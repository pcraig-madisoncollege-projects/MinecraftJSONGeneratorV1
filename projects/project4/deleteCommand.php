<?php
    ...
    $pageTitle = "Delete Saved Tellraw Command";
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "select name, command, datesaved, userID "
                . "from tellraw_commands where id='$id';";
        $result = mysqli_query($dbc, $query)
                or die("Error querying database.");
                
        // Display error if no commands are found
        if (mysqli_num_rows($result) == 1) {
            ...
            // Attempting to remove other user's commands
        ...
        if (!$result) {
            ...
            echo '<div class="container"><h2>Successfully removed tellraw '
                    . 'command</h2><a href="viewCommands.php">Return to View Commands Page</a></div>';
        }
...
<section class="container">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <h4>Saved on <?php echo $dateSaved; ?></h4>
        ...
        <br>
        <a href="viewCommands.php">Cancel</a>
    </form>
</section>
